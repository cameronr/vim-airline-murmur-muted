let g:airline#themes#murmur_muted#palette = {}
...
let s:cterm_normalbg  = 25   " Background for normal mode and file position blocks
let s:gui_normalbg    = '#5F87FF'
let s:cterm_normalfg  = 252   " Foreground for normal mode and file position blocks
let s:gui_normalfg    = '#FFFFFF'

let s:cterm_insertbg  = 28   " Background for insert mode and file position blocks
let s:gui_insertbg    = '#87AF5F'
let s:cterm_insertfg  = 252   " Foreground for insert mode and file position blocks
...
let s:cterm_visualfg  = 252  " Foreground for visual mode and file position blocks
...
let s:cterm_replacefg = 252   " Foreground for replace mode and file position blocks
...
let g:airline#themes#murmur_muted#palette.normal = airline#themes#generate_color_map(s:N1, s:BB, s:N2)
let g:airline#themes#murmur_muted#palette.normal_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur_muted#palette.insert = airline#themes#generate_color_map(s:I1, s:BB, s:I2)
let g:airline#themes#murmur_muted#palette.insert_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur_muted#palette.replace = airline#themes#generate_color_map(s:R1, s:BB, s:R2)
let g:airline#themes#murmur_muted#palette.replace_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur_muted#palette.visual = airline#themes#generate_color_map(s:V1, s:BB, s:V2)
let g:airline#themes#murmur_muted#palette.visual_modified = {'airline_c': [s:gui_alert, s:gui_termbg2, s:cterm_alert, s:cterm_termbg2, 'bold'] ,}
...
let g:airline#themes#murmur_muted#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

" CtrlP plugin colors
if !get(g:, 'loaded_ctrlp', 0)
  finish
endif
let g:airline#themes#murmur_muted#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
